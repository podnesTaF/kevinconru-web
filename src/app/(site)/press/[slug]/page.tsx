    ...
    <main className="page">
      <div className="wrap pd">
        ...
        <header style={{ maxWidth: 820, marginBottom: 48 }}>
          ...
          {item.subtitle && (
            <p className="serif-italic" style={{ fontSize: 22, color: "var(--fg-soft)", margin: "-4px 0 0" }}>
              {item.subtitle}
            </p>
          )}
        </header>
        ...
        {gallery.length > 0 && (
          <section style={{ marginTop: hasBody || item.coverImage ? 80 : 0 }}>
        ...
        {item.pdf && (
          <section style={{ marginTop: 80 }}>
            ...
            <PdfEmbed url={item.pdf.url} title={item.title} />
          </section>
        )}
      </div>
    </main>
