  ...
  return (
    <div className="max-w-2xl space-y-3">
      <ul className="divide-y divide-rule rounded-md border border-rule bg-bg-alt">
            ...
            <li key={id} className="px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <span className="text-sm font-medium">{e.year}</span> <span className="text-sm text-fg-soft">{e.event}</span>
                </div>
        ...
        {order.length === 0 && <li className="px-4 py-6 text-center text-sm text-muted">No entries yet.</li>}
      </ul>
